...
const ProjectOverview: React.FC = () => {
  ...
  return (
    <section id="projects" className={`relative overflow-hidden py-24 ${isDark ? 'bg-slate-950' : 'bg-slate-50'}`}>
          ...
          <GlassCard className="relative overflow-hidden p-8 lg:p-10">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-3xl border border-white/10 bg-slate-950/60 p-6 shadow-[0_24px_60px_rgba(15,23,42,0.25)] backdrop-blur-xl">
                  <p className="text-sm uppercase tracking-[0.24em] text-cyan-300">Role</p>
                  <p className="mt-3 text-2xl font-semibold text-white">{PROJECT_OVERVIEW.role}</p>
                </div>
                <div className="rounded-3xl border border-white/10 bg-slate-950/60 p-6 shadow-[0_24px_60px_rgba(15,23,42,0.25)] backdrop-blur-xl">
                  <p className="text-sm uppercase tracking-[0.24em] text-cyan-300">Experience</p>
                  <p className="mt-3 text-2xl font-semibold text-white">Mindful UI & Motion</p>
                </div>
              </div>
            </div>
          </GlassCard>
          ...
          <div className="space-y-6">
            ...
            <GlassCard className="p-6">
              ...
              <div className="mt-6 space-y-4">
                <div className="rounded-3xl border border-white/10 bg-slate-950/40 p-5 shadow-[0_20px_40px_rgba(0,0,0,0.15)] transition-transform duration-300 hover:-translate-y-1">
                  <p className="text-sm text-slate-300">Soft gradients, glowing accents, and premium glass surfaces create a calm, polished experience.</p>
                </div>
                <div className="rounded-3xl border border-white/10 bg-slate-950/40 p-5 shadow-[0_20px_40px_rgba(0,0,0,0.15)] transition-transform duration-300 hover:-translate-y-1">
                  <p className="text-sm text-slate-300">Unique floating elements and depth layers give the section a distinctive visual identity.</p>
                </div>
              </div>
            </GlassCard>
          </div>
